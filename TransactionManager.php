...
#       $response->headers->set('Access-Control-Allow-Headers', 'Authorization, Content-Type, Accept');
       $response->headers->set('Access-Control-Allow-Headers', 'origin, content-type, accept, X-Custom-Auth, password, username, dwt-md5,token');	     $response->headers->set('Access-Control-Allow-Crendential, true');
	...
	#$response->headers->set('Access-Control-Allow-Origin', 'aperio-core-ehr-dev.aperiohealth.com');
        $event->getResponse()->headers->add(array('Access-Control-Allow-Methods'=> 'GET, POST, PUT, DELETE, OPTIONS, PATCH'));
#       $response->headers->set('Access-Control-Allow-Headers', 'Authorization, Content-Type, Accept');
